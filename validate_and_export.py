...
def main():
    ...
    with app.app_context():
        ...
        tables = [
            (UserRole, "export_user_roles.csv"),
            (User, "export_users.csv"),
            (Clinic, "export_clinic.csv"),
            (Assistant, "export_assistants.csv"),
            (Availability, "export_availability.csv"),
            (Appointment, "export_appointments.csv"),
            (MedicalRecord, "export_medical_records.csv"),
            (Schedule, "export_schedules.csv"),
            (Note, "export_notes.csv"),
            (Publication, "export_publications.csv"),
            (Task, "export_tasks.csv"),
            (Subscriber, "export_subscribers.csv"),
            (CompanyInvite, "export_company_invites.csv"),
            (InvitationLog, "export_invitation_logs.csv"),
            (Visit, "export_visits.csv"),
            (ProductCategory, "export_product_category.csv"),
            (Product, "export_product.csv"),
            (Event, "export_event.csv"),
            (Anuncio, "export_anuncios.csv"),
        ]
